...
namespace TrabalhoLUCAISSA.Controllers
{
    public class JogadorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JogadorID,Idade,Nome,Nacionalidade")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JogadorID,Idade,Nome,Nacionalidade")] Jogador jogador)
        {
